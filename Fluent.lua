...
local Themes = {
	...
	Miguel = {
    Name = "Miguel",
    Accent = Color3.fromRGB(180, 85, 255), -- Đổi thành Tím Sáng (Gốc: Đỏ 255, 60, 60)
    AcrylicMain = Color3.fromRGB(100, 100, 100), -- Sáng hơn chút (Cũ: 80)
    AcrylicBorder = Color3.fromRGB(130, 130, 130), -- Sáng hơn chút (Cũ: 110)
    AcrylicGradient = ColorSequence.new(Color3.fromRGB(80, 80, 80), Color3.fromRGB(80, 80, 80)), -- Sáng hơn chút (Cũ: 60)
    AcrylicNoise = 0.9,
    TitleBarLine = Color3.fromRGB(115, 115, 115), -- Sáng hơn chút (Cũ: 95)
    Tab = Color3.fromRGB(165, 165, 165), -- Sáng hơn chút (Cũ: 145)
    Element = Color3.fromRGB(165, 165, 165), -- Sáng hơn chút (Cũ: 145)
    ElementBorder = Color3.fromRGB(75, 75, 75), -- Sáng hơn chút (Cũ: 55)
    InElementBorder = Color3.fromRGB(130, 130, 130), -- Sáng hơn chút (Cũ: 110)
    ElementTransparency = 0.85, -- Giảm nhẹ độ trong suốt để màu xám nền hiện rõ hơn
    ToggleSlider = Color3.fromRGB(165, 165, 165), -- Sáng hơn chút (Cũ: 145)
    ToggleToggled = Color3.fromRGB(255, 255, 255),
    SliderRail = Color3.fromRGB(165, 165, 165), -- Sáng hơn chút (Cũ: 145)
    DropdownFrame = Color3.fromRGB(205, 205, 205), -- Sáng hơn chút (Cũ: 185)
    DropdownHolder = Color3.fromRGB(85, 85, 85), -- Sáng hơn chút (Cũ: 65)
    DropdownBorder = Color3.fromRGB(75, 75, 75), -- Sáng hơn chút (Cũ: 55)
    DropdownOption = Color3.fromRGB(165, 165, 165), -- Sáng hơn chút (Cũ: 145)
    Keybind = Color3.fromRGB(165, 165, 165), -- Sáng hơn chút (Cũ: 145)
    Input = Color3.fromRGB(205, 205, 205), -- Sáng hơn chút (Cũ: 185)
    InputFocused = Color3.fromRGB(45, 45, 45), -- Sáng hơn chút (Cũ: 25)
    InputIndicator = Color3.fromRGB(195, 195, 195), -- Sáng hơn chút (Cũ: 175)
    Dialog = Color3.fromRGB(85, 85, 85), -- Sáng hơn chút (Cũ: 65)
    DialogHolder = Color3.fromRGB(75, 75, 75), -- Sáng hơn chút (Cũ: 55)
    DialogHolderLine = Color3.fromRGB(70, 70, 70), -- Sáng hơn chút (Cũ: 50)
    DialogButton = Color3.fromRGB(85, 85, 85), -- Sáng hơn chút (Cũ: 65)
    DialogButtonBorder = Color3.fromRGB(120, 120, 120), -- Sáng hơn chút (Cũ: 100)
    DialogBorder = Color3.fromRGB(110, 110, 110), -- Sáng hơn chút (Cũ: 90)
    DialogInput = Color3.fromRGB(95, 95, 95), -- Sáng hơn chút (Cũ: 75)
    DialogInputLine = Color3.fromRGB(205, 205, 205), -- Sáng hơn chút (Cũ: 185)
    Text = Color3.fromRGB(255, 255, 255), 
    SubText = Color3.fromRGB(215, 215, 215), -- Nâng sáng để không bị chìm vào nền xám mới (Cũ: 195)
    Hover = Color3.fromRGB(165, 165, 165), -- Sáng hơn chút (Cũ: 145)
    HoverChange = 0.07,
},
	Darker = {
		Name = "Darker",
...
local Creator = {
	...
	DefaultProperties = {
		...
		TextLabel = {
			BackgroundColor3 = Color3.new(1, 1, 1),
			BorderColor3 = Color3.new(0, 0, 0),
			Font = Enum.Font.SourceSansBold, -- Đã đổi thành SourceSansBold
			Text = "",
