...
v0:AddProfile({
    Name = "jokerbiel13 ☑",             
    Bio = "I LOVE YOU XD", 
    Avatar = "rbxassetid://123035506495251", 
    Cover = "rbxassetid://123035506495251", 
    Verified = true 
})
v0:AddSingleDiscordCard({
"hi Script 💙",
        "Follow our TikTok channel for the latest updates!!!",
        "rbxassetid://123035506495251",
        "rbxassetid://123035506495251",
        2000,
        10000,
        "https://tiktok.me"
...
v0:AddParagraph({
"Notification",
"•Four hub\n• Script by Quang Huy\n• Creation Date: 7-6-2026\n• Last updated date: 7-6-2026\n• Aura gun cannot currently fire at ships and Leviathans"
})
...
local discordContainer = v0:AddDiscordInvite({
    -- Card 1
    {
        "Visite the FourHub Site",
        "Where you will have all the scripts firsthand.",
        "rbxassetid://123035506495251",
        "rbxassetid://123035506495251",
        500,
        1500,
        "https://fourhub13.netlify.app"
    },
    -- Card 2
    {
...
-- ========================================
v14:AddSection({"Craft Sea Event"})
...
v14:AddButton({
    Name = "Switched to Ghoul",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Ectoplasm", "Change", 4)
        bearlib:Notify({Title = "Race", Message = "Switched to Ghoul", Duration = 2})
    end
})

v14:AddButton({
    Name = "Switched to Cyborg",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CyborgTrainer", "Buy")
        bearlib:Notify({Title = "Race", Message = "Switched to Cyborg", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Success", Message = "All codes have been recovered.", Duration = 3})
    end
})
